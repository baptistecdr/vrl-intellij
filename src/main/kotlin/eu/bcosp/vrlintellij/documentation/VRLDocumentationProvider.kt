...
class VRLDocumentationProvider : AbstractDocumentationProvider() {
    ...
    private fun VRLFunction.toHtml(): String = buildString {
        ...
        // description/arg.description are real HTML (a small whitelist - <p>, <code>, <a>, <em>,
        // <strong>, <ul>/<ol>/<li> - generated by scripts/refresh-vrl-functions.mjs to mirror how
        // vector.dev itself renders them), not plain text, so they're appended as-is rather than
        // escaped; escaping would show the literal tags instead of rendering them.
