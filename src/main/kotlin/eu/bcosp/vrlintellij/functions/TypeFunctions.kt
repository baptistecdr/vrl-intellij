...
val typeFunctions = mapOf(
    ...
    "type_def" to VRLFunction(
        name = "type_def",
        description = "Returns the type definition of an expression at runtime. This is a debug function that is UNSTABLE. Behavior is NOT guaranteed even though it is technically usable.",
        isFallible = false,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
