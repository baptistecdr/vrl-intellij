...
val stringFunctions = mapOf(
    ...
    "find" to VRLFunction(
        name = "find",
        description = "Determines from left to right the start position of the first found element in value that matches pattern. Returns null if not found.",
        isFallible = false,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
    ...
    "shannon_entropy" to VRLFunction(
        ...
        description = "Generates Shannon entropy from given string. It can generate it based on string bytes, codepoints, or graphemes.",
        isFallible = false,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
            ...
            VRLFunctionArgument(
                "segmentation",
                setOf("string"),
                "Defines how to split the string to calculate entropy, based on occurrences of segments. Byte segmentation is the fastest, but it might give undesired results when handling UTF-8 strings, while grapheme segmentation is the slowest, but most correct in these cases.",
                false,
                "byte"
            )
        ),
    ...
    "sieve" to VRLFunction(
        name = "sieve",
        description = "Keeps only matches of pattern in value. This can be used to define patterns that are allowed in the string and remove everything else.",
        isFallible = false,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
    ...
    "slice" to VRLFunction(
        name = "slice",
        description = "Returns a slice of value between the start and end positions. If the start and end parameters are negative, they refer to positions counting from the right of the string or array. If end refers to a position that is greater than the length of the string or array, a slice up to the end of the string or array is returned.",
        isFallible = false,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
            ...
            VRLFunctionArgument(
                "end",
                setOf("integer"),
                "The exclusive end position. A zero-based index that can be negative. Defaults to the string or array length.",
                false
            )
        ),
    ...
    "strip_ansi_escape_codes" to VRLFunction(
        ...
        description = "Strips ANSI escape codes from value.",
        isFallible = false,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
    ...
    "strip_whitespace" to VRLFunction(
        ...
        description = "Strips whitespace from the start and end of value, where whitespace is defined by the Unicode White_Space property.",
        isFallible = false,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
    ...
    "truncate" to VRLFunction(
        ...
        arguments = listOf(
            ...
            VRLFunctionArgument(
                "suffix",
                setOf("string"),
                "A custom suffix to be appended to truncated strings. If a custom suffix is provided, the total length of the string will be limit + <suffix length>.",
                false
            )
        ),
        returnTypes = setOf("string")
