...
val parseFunctions = mapOf(
    ...
    "parse_yaml" to VRLFunction(
        name = "parse_yaml",
        description = "Parses the provided value as YAML. Only YAML types are returned. If you need to convert a string into a timestamp, consider the parse_timestamp function.",
        isFallible = true,
        isPure = true,
        arguments = listOf(
            VRLFunctionArgument(
