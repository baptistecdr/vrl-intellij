...
class VRLHighlighter: SyntaxHighlighterBase() {
    ...
    private fun tokenSetMap(tokenType: IElementType?): VRLColor? = when (tokenType) {
        ...
        in VRLHighlightingTokenSets.TEMPLATE_VARIABLE_LITERAL -> VRLColor.TEMPLATE_VARIABLE
        in VRLHighlightingTokenSets.REGEX_LITERAL -> VRLColor.REGEX
        in VRLHighlightingTokenSets.TIMESTAMP_LITERAL -> VRLColor.TIMESTAMP
